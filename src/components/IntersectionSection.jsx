...
const IntersectionSection = () => {
  return (
    <section className="bg-black text-white px-6 py-16 md:px-16">
      <div className="max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center gap-12">
        {/* Left Text Content */}
        <div className="lg:w-1/4">
          <h2 className="font-alliance text-sm uppercase text-gray-400 font-semibold leading-tight mb-4">
            INQUANT <br/>
            SERVICES WING 
          </h2>
        </div>
        ...
        <div className="lg:w-1/2">
          <h2 className="font-alliance text-3xl md:text-4xl font-normal leading-tight mb-10">
            Built at the Intersection of <br />
            Quant, Code & Cloud.
          </h2>
          <p className="font-alliance uppercase text-gray-400 text-sm leading-relaxed mb-10">
        ...
        <div className="lg:w-1/2 flex justify-center">
          <div className="w-full h-64 md:h-72 lg:h-80 rounded-3xl overflow-hidden bg-gray-900 border border-gray-700 shadow-lg">
            <img
